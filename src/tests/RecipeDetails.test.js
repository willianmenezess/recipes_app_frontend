...
describe('Desenvolva a tela de modo que contenha uma imagem da receita, o título, a categoria em caso de comidas e se é ou não alcoólico em caso de bebidas, uma lista de ingredientes seguidos pelas quantidades, instruções, um vídeo do youtube incorporado e recomendações', () => {
  test('Verifica se os elementos existem na tela de detalhes da bebida mockada "A1"', async () => {
    renderWithRouter('/drinks/52771');
